...
<nav id="sidebar" class='mx-lt-5 bg-dark'>
    <div class="sidebar-list">
        ...
        <?php if($_SESSION['login_type'] == 1): ?>
            ...
            <a href="hr_scheduler.php" class="nav-item nav-schedule-interview"><span class='icon-field'><i class="fa fa-calendar-check"></i></span> Schedule Interview</a>
        <?php endif; ?>

        <!-- Updated link for sending mail to candidates -->
        <a href="send_mail.php" class="nav-item nav-send-mail"><span class='icon-field'><i class="fa fa-envelope"></i></span> Send Mail to Candidate</a>
    </div>
</nav>
<script>
